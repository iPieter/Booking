...
<div class="container">
	<form class="form-signin" role="form" action="login.php" method="post">
        ...
        <select name="username" id="username" class="form-control" required="" autofocus="">
        	<option>Pieter Delobelle</option>
        	<option>Pieter Vanhaverbeke</option>
        	<option>Lynn</option>
        	<option>Emma</option>
        	<option>Loes</option>
        ...
        <label class="checkbox">
        	<input type="checkbox" value="remember-me" name="remember-me"> Mij onthouden
        </label>
